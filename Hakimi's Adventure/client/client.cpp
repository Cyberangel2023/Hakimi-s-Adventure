...
Path path = Path(
	...
	{3162,1722},{2122,1722},{21122,1562},
	{842,1562},{842,842}
	});  // 角色移动路径对象
    ...
    while (true)
    {
        ...
        else
        {
                ...
                || (id_player == 2 && progress_2 >= num_total_char))
            {
                ...
                MessageBox(hwnd, _T("赢麻麻！"), _T("游戏结束"), MB_OK | MB_ICONERROR);
                exit(0);
            }
            ...
            {
                stop_audio(_T("bgm"));
                MessageBox(hwnd, _T("输光光！"), _T("游戏结束"), MB_OK | MB_ICONERROR);
                exit(0);
            }
        ...
        else
        {
            ...
            case 3:
            {
                ...
                putimage_ex(camera_scene, &img_ui_3, &rect_ui_3);
            }
            break;
            case 2:
            {
                ...
                putimage_ex(camera_scene, &img_ui_2, &rect_ui_2);
            }
            break;
            case 1:
            {
                ...
                putimage_ex(camera_scene, &img_ui_1, &rect_ui_1);
            }
            break;
            case 0:
            {
                ...
                putimage_ex(camera_scene, &img_ui_fight, &rect_ui_fight);
            }
            break;
            default: break;
            }
